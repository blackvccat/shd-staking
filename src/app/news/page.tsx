...
const NEWS_LIST: NewsItem[] = [
  {
    id: 1,
    title: "SHD 数据资产质押系统正式上线",
    summary:
      "可信数据空间酒类数据资产平台 DAPP 正式上线，用户可参与质押获取每日收益。",
    content:
      "可信数据空间酒类数据资产平台 DAPP 已于今日正式上线。用户可通过连接钱包参与 SHD 数据资产质押，选择 7 天、30 天、180 天或 360 天等不同周期，获取对应的日化收益。同时，平台支持推荐好友获取 10% 直推奖励，共建生态共同受益。",
    date: "2026-04-07",
  },
  {
    id: 2,
    title: "SHD 经济模型",
    summary:
      "SHD 数据资产总发行量 2 亿枚，含交易税机制，支持质押与兑换。",
    content:
  ...
  },
  {
    ...
    title: "质押收益规则与团队奖励说明",
    summary:
      "详细说明质押收益计算方式、推荐奖励机制以及团队等级体系。",
    content:
      "一、静态收益\n选择不同质押周期可获得对应日化收益率：\n• 7 天周期\n• 30 天周期\n• 180 天周期\n• 360 天周期\n\n二、直推奖励\n推荐好友质押可获得下级质押金额的 10% 作为直推收益。\n\n三、团队极差收益\n根据小区业绩达到不同 V 等级，可获得对应比例的团队极差收益：\nV1-V5 分别对应 5%-25% 的极差比例\nV6 可参与全网 5% 的加权分红。",
    date: "2026-04-05",
  },
];

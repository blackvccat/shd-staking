...
export function HeroBanner() {
  return (
    <section>
      <div className="relative h-[45vh] w-full overflow-hidden touch-none sm:h-[60vh]">
        <Canvas
      ...
      <div className="relative z-10 -mt-6 flex flex-col items-center px-4 pb-8 sm:-mt-10 sm:px-5 sm:pb-12">
        <h1 className="mb-1.5 text-center text-2xl font-semibold leading-tight text-text-primary animate-slide-up opacity-0 sm:mb-2 sm:text-4xl" style={{ animationDelay: "0.2s" }}>
          可信数据空间酒类数据资产平台
        </h1>
        <p className="mb-5 text-center text-xs text-text-secondary animate-slide-up opacity-0 sm:mb-6 sm:text-sm" style={{ animationDelay: "0.35s" }}>
          酒类交易平台 · 质押生态系统
        </p>
        <a
          href="/staking"
